...
(defun proto3-create-serialization-functions ()
  (proto-impl::make-serializer proto3-proto:population)
  (proto-impl::make-serializer proto3-proto:person)
  (proto-impl::make-serializer proto3-proto:address)
  (proto-impl::make-deserializer proto3-proto:population)
...
(deftest proto3-serialization-times (timing-suite)
  (let ((population (proto3-proto:make-population))
    ...
    (benchmark:with-timing (1000)
      (serialize-object-to-bytes population (type-of population)))
    (let* ((buffer (serialize-object-to-bytes population (type-of population)))
           (result (deserialize-object-from-bytes (type-of population) buffer)))
      (assert-true (proto:proto-equal population result :exact t))

      (print "Proto3 Performance Test Deserialization")
      (benchmark:with-timing (1000)
        (deserialize-object-from-bytes (type-of population) buffer)))
...
(defun proto2-create-serialization-functions ()
  (proto-impl::make-serializer serial-proto:population)
  (proto-impl::make-serializer serial-proto:person)
  (proto-impl::make-serializer serial-proto:address)
  (proto-impl::make-deserializer serial-proto:population)
