...
(deftest test-oneof-equal-with-same-submessage (oneof-suite)
  (let* ((intlist (make-oneof-test.int-list :ints (list 1 2 3 4 5)))
         (oneof-test-1 (make-oneof-test :list-of-ints intlist))
         (oneof-test-2 (make-oneof-test :list-of-ints intlist))
         ...
         (desc (find-message-descriptor 'oneof-test))
         (oneof-descriptor
          (find 'cl-protobufs.oneof-test::my-oneof (proto-oneofs desc)
                :key #'pi::oneof-descriptor-external-name)))

    (assert-true (cl-protobufs.implementation::oneof-field-equal
                  oneof-1
                  oneof-2
                  oneof-descriptor t))))

(deftest test-oneof-equal-with-different-submessage (oneof-suite)
  (let* ((intlist-1 (make-oneof-test.int-list :ints (list 1 2 3 4 5)))
         (intlist-2 (make-oneof-test.int-list :ints (list 1 2 3 4)))
         (oneof-test-1 (make-oneof-test :list-of-ints intlist-1))
         (oneof-test-2 (make-oneof-test :list-of-ints intlist-2))
         (oneof-1 (cl-protobufs.oneof-test::oneof-test-%my-oneof oneof-test-1))
         (oneof-2 (cl-protobufs.oneof-test::oneof-test-%my-oneof oneof-test-2))
         (desc (find-message-descriptor 'oneof-test))
         (oneof-descriptor
    ...
    (assert-false (cl-protobufs.implementation::oneof-field-equal
                   oneof-1 oneof-2 oneof-descriptor t))))

(deftest test-oneof-equal-with-submessage-and-scalar (oneof-suite)
  (let* ((intlist (make-oneof-test.int-list :ints (list 1 2 3 4 5)))
         (oneof-test-1 (make-oneof-test :list-of-ints intlist))
