...
(deftest struct-roundtrip (json-suite)
  (let* ((null-val (google:make-value :null-value :null-value))
    ...
    (push (google:make-value :struct-value struct1)
          (google:list-value.values list-val-proto))
    (let ((struct2 (google:make-struct))
          (list-proto2 (google:make-list-value :values (list struct1))))
      ...
      (json-roundtrip struct1-val)
      (json-roundtrip struct2-val))))
